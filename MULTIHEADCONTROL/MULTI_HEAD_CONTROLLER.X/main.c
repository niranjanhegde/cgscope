...
int main(void) {
    ...
    if(HEAD_SELECT_2_GetValue() == 0) head_select=Minuature_Head2;
    if(HEAD_SELECT_3_GetValue() == 0) head_select=Standard_Head1;
    if(HEAD_SELECT_4_GetValue() == 0) head_select=Standard_Head2;
